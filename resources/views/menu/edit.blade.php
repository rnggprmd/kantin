...
<div class="max-w-5xl mx-auto py-6" x-data="{ 
    ...
    <form method="POST" action="{{ route('menu.update', $menu->id) }}" enctype="multipart/form-data" class="space-y-10">
        @csrf @method('PUT')
                ...
                <div class="bg-white rounded-xl p-1 shadow-sm ring-1 ring-gray-900/5">
                    <div class="relative border-2 border-dashed border-gray-300 hover:border-primary/50 bg-gray-50/50 hover:bg-primary/5 rounded-lg transition-all overflow-hidden group min-h-[16rem] flex flex-col items-center justify-center"
                        ...
                        <div class="p-8 text-center flex flex-col items-center" x-show="!preview" x-transition>
                            ...
                            <p class="text-gray-900 font-bold text-base">Ganti Foto Menu</p>
                        ...
                        <div x-show="preview" x-cloak class="absolute inset-0 z-0 p-2">
                            <img :src="preview" class="w-full h-full object-cover rounded-md shadow-sm border border-gray-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-4">
                ...
                <p class="text-sm text-gray-500 mt-2 leading-relaxed">Update identitas menu agar tetap relevan dengan ketersediaan di dapur.</p>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-6 sm:p-8">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="sm:col-span-2">
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Deskripsi Kandungan <span class="text-gray-400 font-normal normal-case">(Opsional)</span></label>
                            <textarea name="deskripsi" rows="3"
                                      ...
                                      placeholder="Ketikkan info komposisi bahan atau catatan khusus...">{{ old('deskripsi', $menu->deskripsi) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-4">
                ...
                <p class="text-sm text-gray-500 mt-2 leading-relaxed">Sesuaikan stok dan harga jual terkini.</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="harga" value="{{ old('harga', $menu->harga) }}" required min="0" placeholder="0"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="stok" value="{{ old('stok', $menu->stok) }}" required min="0"

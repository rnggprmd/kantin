@extends('layouts.app')
@section('title', 'Registrasi Otoritas')
@section('page-title', 'Otoritas Akses Baru')

@section('content')
<div class="max-w-5xl mx-auto py-6" x-data="{ role: '{{ old('role', 'kasir') }}' }">

    <div class="flex items-center justify-between pb-6 mb-8 border-b border-gray-200">
        <div>
            <h2 class="text-2xl font-black text-gray-900 tracking-tight">Kredensial Baru</h2>
            <p class="text-sm text-gray-500 font-medium mt-1">Buat hak akses personel untuk menggunakan terminal POS Kantin Maria.</p>
        </div>
    ...
    <form method="POST" action="{{ route('pengguna.store') }}" class="space-y-10">
        @csrf
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-4">
                ...
                <p class="text-sm text-gray-500 mt-2 leading-relaxed">Identitas ini akan direkam secara permanen pada setiap jejak transaksi yang dilakukan.</p>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-6 sm:p-8">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="sm:col-span-2">
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Nama Lengkap (Sesuai ID/KTP) <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Alamat Email Aktif <span class="text-red-500">*</span></label>
                            <input type="email" name="email" value="{{ old('email') }}" required
                                   class="w-full bg-gray-50/50 border border-gray-300 text-gray-900 placeholder-gray-400 rounded-lg px-4 py-3 text-sm font-semibold focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary focus:bg-white transition-colors"
                                   placeholder="staff@kantinmaria.com">
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Nomor Telepon <span class="text-gray-400 font-normal normal-case">(Opsional)</span></label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-4">
                <h3 class="text-lg font-bold text-gray-900">Hak Akses & Sandi</h3>
                <p class="text-sm text-gray-500 mt-2 leading-relaxed">Administrator memiliki otoritas penuh. Berikan peran kasir untuk operasional harian.</p>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-6 sm:p-8 space-y-8">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="sm:col-span-2 relative">
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Level Otoritas <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Kata Sandi Baru <span class="text-red-500">*</span></label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-2">Konfirmasi Sandi <span class="text-red-500">*</span></label>
                    ...
                    <div x-data="{ isActive: {{ old('is_active', 'true') === 'true' || old('is_active') === '1' ? 'true' : 'false' }} }">
                        <div class="bg-gray-50/80 rounded-lg p-5 border border-gray-100 flex items-center justify-between">
                            <div>
                                <h4 class="text-sm font-bold text-gray-900">Status Akun (Aktif)</h4>
                                <p class="text-xs text-gray-500 mt-1">Nonaktifkan untuk membekukan (suspend) akses sementara.</p>
                            </div>

...
<div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative z-10">
            <div>
                ...
                <h2 class="text-2xl lg:text-3xl font-black leading-tight">
                    Selamat datang, <span class="text-tertiary"><?php echo e(Str::words(auth()->user()->name, 1, '')); ?></span>!
                </h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="stat-card anim-card rounded-2xl p-5 shadow-lg"
            ...
            <p class="text-2xl font-black text-white tracking-tight">Rp <?php echo e(number_format($pendapatanHariIni, 0, ',', '.')); ?></p>
        </div>
        ...
        <div class="stat-card anim-card rounded-2xl p-5 shadow-lg"
            ...
            <p class="text-2xl font-black text-white tracking-tight"><?php echo e($transaksiHariIni); ?> <span class="text-sm font-semibold text-white/30">nota</span></p>
        </div>

        
        <a href="<?php echo e(route('transaksi.index', ['status' => 'pending'])); ?>"
           ...
           style="background: linear-gradient(135deg, #451a03 0%, #15173D 100%); border: 1px solid rgba(255,255,255,0.06);">
            ...
            <p class="text-2xl font-black <?php echo e($transaksiPending > 0 ? 'text-amber-400' : 'text-white'); ?> tracking-tight">
                <?php echo e($transaksiPending); ?> <span class="text-sm font-semibold text-white/30">nota</span>
            </p>
        </a>
        ...
        <div class="stat-card anim-card rounded-2xl p-5 shadow-lg"
            ...
            <p class="text-2xl font-black text-white tracking-tight">
                <?php echo e($totalMenuAktif); ?> <span class="text-sm font-semibold text-white/30">item</span>
            </p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div class="anim-panel bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                ...
                ?>
                <?php $__currentLoopData = ['tunai' => 'payments', 'non_tunai' => 'qr_code_2']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metode => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between items-center text-xs font-bold uppercase">
                            <div class="flex items-center gap-2 text-gray-500">
                                <span class="material-symbols-outlined !text-[16px] text-<?php echo e($color); ?>-500"><?php echo e($icon); ?></span>
                                <?php echo e(str_replace('_', ' ', $metode)); ?>

                            </div>
                            <span class="text-gray-900"><?php echo e($count); ?> Txn</span>
                        </div>
                        <div class="h-2 bg-gray-50 rounded-full overflow-hidden border border-gray-100">
                            <div class="h-full bg-<?php echo e($color); ?>-500 rounded-full transition-all duration-1000" style="width: <?php echo e($pct); ?>%"></div>
                        </div>
                    </div>
        ...
        <div class="anim-panel bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-3">
                <?php $__empty_1 = true; $__currentLoopData = $performaKategori->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-100 group hover:border-primary/20 transition-all">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-xs font-black text-gray-700"><?php echo e($kat->nama); ?></p>
                    </div>
                    <p class="text-[11px] font-black text-primary">Rp <?php echo e(number_format($kat->total_pendapatan, 0, ',', '.')); ?></p>
                </div>
        ...
        <div class="anim-panel bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $kantinTeraktif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kantin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center text-[10px] font-black border border-indigo-100">
                        <?php echo e(substr($kantin->name, 0, 1)); ?>

                    </div>
                    <div class="flex-1">
                        <p class="text-xs font-black text-gray-800"><?php echo e($kantin->name); ?></p>
                        <p class="text-[10px] text-gray-400 font-bold uppercase"><?php echo e($kantin->total_transaksi); ?> Transaksi</p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <tr class="txn-row border-b border-gray-50 last:border-0">
                            <td class="px-6 py-3.5">
                                <span class="inline-flex items-center gap-1.5 text-gray-400 text-xs font-semibold">
                                    ...
                                    <?php echo e($t->created_at->format('H:i')); ?>

                                </span>
                            </td>
                            <td class="px-6 py-3.5">
                                <code class="text-[11px] text-primary bg-primary/5 px-2 py-0.5 rounded font-bold tracking-tight"><?php echo e($t->kode_transaksi); ?></code>
                            </td>
                            <td class="px-6 py-3.5 text-gray-700 font-semibold text-sm"><?php echo e($t->user?->name ?? 'Sistem'); ?></td>
                            <td class="px-6 py-3.5 text-right">
                                <span class="text-gray-900 font-black text-sm tracking-tight">Rp <?php echo e(number_format($t->total_harga, 0, ',', '.')); ?></span>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                ...
                <div class="flex flex-col gap-2">
                    <div class="flex items-center justify-between gap-3">
                        <div class="flex items-center gap-3 min-w-0">
                            <div class="rank-badge <?php echo e($c['card']); ?> border <?php echo e($c['text']); ?>">
                                #<?php echo e($i + 1); ?>

                            </div>
                            <p class="text-sm font-bold text-gray-800 truncate"><?php echo e($menu->nama_menu); ?></p>
                        </div>
                        <span class="shrink-0 text-xs font-black <?php echo e($c['text']); ?>"><?php echo e($menu->total_terjual); ?>×</span>
                    </div>
                    <div class="progress-bar-track bg-gray-100">
                        <div class="progress-bar-fill" style="width: <?php echo e($pct); ?>%; background: linear-gradient(90deg, <?php echo e(['#f59e0b','#9ca3af','#f97316'][$i] ?? '#a855f7'); ?>, <?php echo e(['#d97706','#6b7280','#ea580c'][$i] ?? '#7c3aed'); ?>);"></div>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const rawData = <?php echo json_encode($grafikData, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kantin\resources\views/dashboard/index.blade.php ENDPATH**/ ?>